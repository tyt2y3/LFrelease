define({
  bmp: {
    ...
    weapon_hp: 200,
    weapon_drop_hurt: 35,
    weapon_hit_sound: "sound/023.ogg",
    weapon_drop_sound: "sound/023.ogg",
    weapon_broken_sound: "sound/066.ogg"
  },
  ...
  60: { name: "on_ground",
    pic: 2, state: 1003, wait: 1, next: 61, dvx: 0, dvy: 0, centerx: 36, centery: 56, hit_a: 0, hit_d: 0, hit_j: 0, sound: "sound/023.ogg"
  },
  61: { name: "on_ground",
    pic: 5, state: 1003, wait: 2, next: 62, dvx: 0, dvy: 0, centerx: 31, centery: 43, hit_a: 0, hit_d: 0, hit_j: 0
  },
  62: { name: "on_ground",
    pic: 3, state: 1003, wait: 2, next: 63, dvx: 0, dvy: 0, centerx: 34, centery: 46, hit_a: 0, hit_d: 0, hit_j: 0, sound: "sound/023.ogg"
  },
  63: { name: "on_ground",
  ...
  70: { name: "just_on_ground",
    pic: 2, state: 1003, wait: 1, next: 71, dvx: 0, dvy: 0, centerx: 37, centery: 52, hit_a: 0, hit_d: 0, hit_j: 0, sound: "sound/023.ogg",
    itr: {
  ...
  72: { name: "just_on_on_ground",
    pic: 3, state: 1003, wait: 2, next: 64, dvx: 0, dvy: 0, centerx: 35, centery: 46, hit_a: 0, hit_d: 0, hit_j: 0, sound: "sound/023.ogg",
    itr: {
