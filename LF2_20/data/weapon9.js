define({
  bmp: {
    ...
    weapon_hp: 200,
    weapon_drop_hurt: 35,
    weapon_hit_sound: "sound/027.ogg",
    weapon_drop_sound: "sound/027.ogg",
    weapon_broken_sound: "sound/027.ogg"
  },
  ...
  60: { name: "on_ground",
    pic: 17, state: 1003, wait: 1, next: 61, dvx: 0, dvy: 0, dvz: 0, centerx: 25, centery: 33, hit_a: 0, hit_d: 0, hit_j: 0, sound: "sound/027.ogg"
  },
  61: { name: "on_ground",
    pic: 18, state: 1003, wait: 2, next: 62, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 31, hit_a: 0, hit_d: 0, hit_j: 0
  },
  62: { name: "on_ground",
    pic: 17, state: 1003, wait: 2, next: 63, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 32, hit_a: 0, hit_d: 0, hit_j: 0, sound: "sound/027.ogg"
  },
  63: { name: "on_ground",
  ...
  70: { name: "just_on_ground",
    pic: 2, state: 1003, wait: 1, next: 71, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 35, hit_a: 0, hit_d: 0, hit_j: 0, sound: "sound/027.ogg",
    itr: {
  ...
  72: { name: "just_on_on_ground",
    pic: 3, state: 1003, wait: 2, next: 64, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 31, hit_a: 0, hit_d: 0, hit_j: 0, sound: "sound/027.ogg",
    itr: {
      kind: 0, x: 1, y: 19, w: 46, h: 15, dvx: 2, fall: 40, arest: 16, bdefend: 16
    }
  },
